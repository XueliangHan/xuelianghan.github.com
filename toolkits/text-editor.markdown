...
###Sublime (Web Dev.)
* Offical Website: [Sublime](http://www.sublimetext.com/2): Designed for Web Development, support Mac OS X, and Windows as far as I know.
* Documentation: [Offical Documentation of Sublime 2](http://www.sublimetext.com/docs/2/) - _The Sublime documentation is currently a work in progress. (@2013-07-16)
* Keyboard shortcuts: [Mac OS X](http://docs.sublimetext.info/en/latest/reference/keyboard_shortcuts_osx.html), on [Linux and Windows](http://docs.sublimetext.info/en/latest/reference/keyboard_shortcuts_win.html)
* Setup Sublime 2
  * 1.Install sublime
