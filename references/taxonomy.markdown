...
* Refernece type - Zotero（中文）：
  ...
  * 完整： E-mail、TV广播、专利、书籍、会议论文、信件、博客帖子、即时讯息、听证会、图书章节、地图、账单、手稿、报告稿、博客、文档、新闻文章、无线广播、期刊文章、杂志文章、案例、法规、演示文档、电影、百科全书文章、艺术品、视频剪辑、计算机程序、论坛帖子、论文、词条、采访稿、音频剪辑。

* Citation type (Chinese)
  1. 专著M： ［序号］作者.书名[M].版本(第1版不著录).出版地:出版者,出版年.起止页码.
  2. 期刊J: ［序号］作者.题名[J].刊名,年,卷(期):起止页码.
  3. 会议论文集AC（或汇编）: ［序号］作者.题名[A].编者.论文集名[C].出版地:出版者,出版年.起止页码.
  4. 学位论文D: ［序号］作者. 题名[D]. 学位授予地址：学位授予单位，年份.
  5. 专利P: ［序号］专利申请者. 专利题名[P].专利国别（或地区）:专利号, 出版日期.
  6. 科技报告R: ［序号］著者. 报告题名[R].编号，出版地：出版者，出版年.起止页码.
  7. 标准S: ［序号］ 标准编号，标准名称[S].颁布日期.
  8. 报纸文章N : [序号] 作者. 题名[N]. 报纸名，年-月-日（版次）.
  9. 电子文献: ［序号］ 主要责任者.电子文献题名［电子文献及载体类型标识］.电子文献的出处或可获得地址，发表或更新日期/引用日期  (任选).
  10. 各种未定义类型的文献Z: ［序号］主要责任者.文献题名［Z］. 出版地：出版者，出版年.
